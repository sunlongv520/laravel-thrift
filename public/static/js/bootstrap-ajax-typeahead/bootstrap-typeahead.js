!function($) {
    ...
    var TypeaheadAjax = function(element, options) {
        ...
        that.options = $.extend({}, $.fn.typeaheadajax.defaults, options);
        ...
        if (that.options.ajax) {
            ...
            if (typeof ajax === 'string') {
                that.ajax = $.extend({}, $.fn.typeaheadajax.defaults.ajax, {
                    url: ajax
                });
            } else {
                ...
                that.ajax = $.extend({}, $.fn.typeaheadajax.defaults.ajax, ajax);
            }
    ...
    $.fn.typeaheadajax = function(option) {
        return this.each(function() {
            ...
            if (!data)
                $this.data('typeaheadajax', (data = new TypeaheadAjax(this, options)));
