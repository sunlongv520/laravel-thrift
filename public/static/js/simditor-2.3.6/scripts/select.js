...
Select = (function(superClass) {
  ...
  Select.prototype._init = function() {
    ...
    this.ajaxUrl = this.opts.ajaxUrl || this.opts.el.data("ajax");
  ...
  Select.prototype._keydown = function(e) {
    ...
    if (e.which === 40 || e.which === 38) {
      ...
      e.preventDefault();
      this.input.blur();
    } else if (e.which === 8 && !this.ajaxUrl) {
  ...
  Select.prototype._keyup = function(e) {
    ...
    return this._keydownTimer = setTimeout((function(_this) {
      return function() {
        ...
        if (_this.ajaxUrl) {
          _.debounce(_this.ajaxGet(value), 500, true);
          return;
        }
        try {
  ...
  Select.prototype.ajaxGet = function(value) {
    var url;
    if (value === this._ajaxSearchValue) {
      return;
    }
    this._ajaxSearchValue = value;
    url = this.ajaxUrl + '&query=' + value;
    return $.get(url, (function(_this) {
      return function(items) {
        ...
        if ($.isArray(items) && items.length > 0) {
          _this.requireSelect = true;
        }
        _this.select.toggleClass('require-select', _this.requireSelect);
        _this.generateList();
