        ...
        <div class="col-sm-12">
            <section class="panel">
                ...
                <div class="panel-body ">
                    ...
                    @endif
                    <form method="POST" action="{{route('admin.user.update')}}" accept-charset="UTF-8" class="form-horizontal">
                        <input name="_token" type="hidden" value="{{csrf_token()}}">
                        <input name="user[id]" type="hidden" value="{{$uiserinfo->id}}">
                        <input name="_method" type="hidden" value="put">
                        <div class="form-group">
                            <label class="col-sm-3 control-label"><i class="required">*</i>用户名</label>
                            <div class="col-sm-8">
                                <input type="text" class="form-control" name="user[username]" value="{{$uiserinfo->username}}">
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control" name="user[realname]" value="{{$uiserinfo->realname}}">
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control" name="user[email]" placeholder="例如：***@**.com" value="{{$uiserinfo->email}}">
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control" name="user[mobile]" placeholder="例如：15888888888" value="{{$uiserinfo->mobile}}">
                            </div>
                        </div>


                        <div class="form-group">
                            <label class="col-sm-3 control-label"><i class="required">*</i>新密码</label>
                            <div class="col-sm-8">
                                <input type="password" class="form-control" placeholder="默认不填" name="user[password]" value="">
                            </div>
                        </div>
