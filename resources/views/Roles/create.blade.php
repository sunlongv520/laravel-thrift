        ...
        <div class="col-sm-12">
            <section class="panel">
                ...
                <div class="panel-body ">
                    ...
                    @endif
                    <form method="POST" action="{{route('admin.roles.store')}}" accept-charset="UTF-8" class="form-horizontal">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control" name="roles[slug]" value="">
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control" name="roles[description]" placeholder="" value="">
                            </div>
                        </div>
